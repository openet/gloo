...
type Gateway struct {
	...
	RolloutJob                    *RolloutJob        `json:"rolloutJob,omitempty" desc:"This job waits for the 'gateway' deployment to successfully roll out (if the validation webhook is enabled), and then applies the Gloo Edge custom resources."`
